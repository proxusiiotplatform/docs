...
```bash 
curl -LO https://raw.githubusercontent.com/proxusiiotplatform/docs/main/docker-compose.yml
```

If you have `wget`:

```bash 
wget https://raw.githubusercontent.com/proxusiiotplatform/docs/main/docker-compose.yml
```
