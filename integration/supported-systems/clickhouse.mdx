...
<Accordion title="Parameter Details">
  <CardGroup>
    <Card title="Host" icon="fas fa-server" href="https://clickhouse.com" color="#4CAF50">
      ClickHouse server hostname or IP
    </Card>
    <Card title="Port" icon="fas fa-plug" href="https://clickhouse.com/docs/en/integrations/" color="#2196F3">
      ClickHouse HTTP port (default: 8123)
    </Card>
    <Card title="Username" icon="fas fa-user" color="#FF9800">
      ClickHouse username
    </Card>
    <Card title="Password" icon="fas fa-lock" color="#F44336">
      ClickHouse password
    </Card>
    <Card title="Database" icon="fas fa-database" color="#673AB7">
      Target database name
    </Card>
    <Card title="Table" icon="fas fa-table" color="#FF5722">
      Target table name
    </Card>
    <Card title="WriteIntervalSeconds" icon="fas fa-clock" color="#009688">
      Buffer flush interval in seconds
    </Card>
    <Card title="TTLExpression" icon="fas fa-hourglass-end" color="#3F51B5">
      Optional: Time-to-live expression for data retention
    </Card>
    <Card title="Documentation" icon="fas fa-book" href="https://clickhouse.com/docs/en/" color="#E91E63">
      Visit ClickHouse documentation
    </Card>
    <Card title="Support" icon="fas fa-headset" href="https://clickhouse.com/contact/" color="#FFEB3B">
      Contact ClickHouse support
    </Card>
    <Card title="Image Card" img="https://example.com/image.jpg" horizontal>
