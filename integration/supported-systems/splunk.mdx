...
This MDX content is optimized for Mintlify and includes links, structured sections, and code examples to help users understand and implement the integration. Let me know if you need further refinements! 😊